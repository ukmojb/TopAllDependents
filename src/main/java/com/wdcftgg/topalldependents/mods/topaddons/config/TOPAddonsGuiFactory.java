...
public class TOPAddonsGuiFactory implements IModGuiFactory {
    ...
    public static class TOPAddonsConfigGuiScreen extends GuiConfig {
        ...
        private static List<IConfigElement> getConfigElements() {
            ...
            for (String s : TopAllDependents.config.getCategoryNames()) {
                subCategories.add(new DummyConfigElement.DummyCategoryElement("topaddonsServerCfg" + s, "topaddons.config:category_server_" + s, new ConfigElement(TopAllDependents.config.getCategory(s)).getChildElements()));
        ...
        public static class ClientEntry extends GuiConfigEntries.CategoryEntry {
            ...
            protected GuiScreen buildChildScreen() {
                return new GuiConfig(this.owningScreen,
                        new ConfigElement(TopAllDependents.configClient.getCategory("Client Options")).getChildElements(),
                        Reference.MOD_ID,
                        false, false, GuiConfig.getAbridgedConfigPath(TopAllDependents.configClient.toString()));
            }
        }
    }
}
